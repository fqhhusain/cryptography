...
with open("output.txt", "r") as f:
    n = Integer(int(f.readline().split(" = ")[_sage_const_1 ], _sage_const_0 ))
    e = Integer(int(f.readline().split(" = ")[_sage_const_1 ], _sage_const_0 ))
    c = Integer(int(f.readline().split(" = ")[_sage_const_1 ], _sage_const_0 ))
